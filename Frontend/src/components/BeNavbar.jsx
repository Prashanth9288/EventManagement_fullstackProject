...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/90 dark:bg-mirage/90 backdrop-blur-md border-b border-gray-100 dark:border-fiord fixed w-full top-0 left-0 z-50 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <Link to="/" className="text-gray-600 dark:text-casper hover:text-teal-600 dark:hover:text-teal-400 font-medium transition-colors">
              Home
            </Link>
            <Link to="/about" className="text-gray-600 dark:text-casper hover:text-teal-600 dark:hover:text-teal-400 font-medium transition-colors">
              About
            </Link>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden bg-white dark:bg-mirage border-t border-gray-100 dark:border-fiord absolute w-full shadow-xl">
          <div className="flex flex-col space-y-2 p-6">
            <Link
              to="/"
              className="text-gray-700 dark:text-casper hover:text-teal-600 font-medium py-2"
            ...
            <button 
                ...
                className="flex items-center gap-2 text-gray-700 dark:text-casper font-medium py-2"
            >
                {isDarkMode ? <><FaSun className="text-yellow-400" /> Light Mode</> : <><FaMoon className="text-gray-600" /> Dark Mode</>}
            </button>
