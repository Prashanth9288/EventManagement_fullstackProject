  ...
  return (
      ...
      <div className="bg-white dark:bg-bluewood shadow-xl rounded-3xl p-10 w-full max-w-md border border-gray-100 dark:border-fiord relative z-10 mx-4 transition-all duration-300">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-lynch">Join thousands of event enthusiasts</p>
        </div>
        ...
        <div className="flex bg-gray-100 dark:bg-mirage p-1 rounded-xl mb-6">
            <button 
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-bold transition-all ${formData.role === 'user' ? 'bg-white dark:bg-bluewood text-gray-900 dark:text-white shadow-sm' : 'text-gray-500 dark:text-lynch hover:text-gray-700 dark:hover:text-white'}`}
            >
                Attendee
            </button>
            <button 
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-bold transition-all ${formData.role === 'organizer' ? 'bg-white dark:bg-bluewood text-teal-600 dark:text-teal-400 shadow-sm' : 'text-gray-500 dark:text-lynch hover:text-gray-700 dark:hover:text-white'}`}
            >
                Organizer
            </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-casper mb-1.5 ml-1">Full Name</label>
            <input
                type="text"
                name="name"
                value={formData.name}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-casper mb-1.5 ml-1">Password</label>
            <input
                type="password"
                name="password"
